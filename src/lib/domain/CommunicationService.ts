...
export class CommunicationService {
  ...
  static async receive(fromPhone: string, messageText: string, msgTimestamp?: string | number): Promise<{ handled: boolean; reply?: string }> {
    ...
    const { CustomerRepository } = await import('../../features/sales/repositories/CustomerRepository');
    const { SalesMissionService } = await import('../../features/sales/services/SalesMissionService');
    ...
    if (matchedCustomer) {
      ...
      const { SalesMissionRepository } = await import('../../features/sales/repositories/SalesMissionRepository');
    ...
    const { SupplierRepository } = await import('@/features/procurement/repositories/SupplierRepository');
    const { ProcurementMissionRepository } = await import('@/features/procurement/repositories/ProcurementMissionRepository');
